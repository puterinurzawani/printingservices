...
class DocumentPrinting extends StatefulWidget {
  final String userId;
  DocumentPrinting({required this.userId});

  @override
  _DocumentPrintingState createState() => _DocumentPrintingState();
}

class _DocumentPrintingState extends State<DocumentPrinting> {
  int activeStep = 0;
  var sizeValue;
    ...
    HttpAuth.postApi(jsons: jsons, url: 'display_size.php').then((value) {
      if (value.statusCode == 200) {
        ...
        sizeDisplay = sizedisplay.sizeDisplay
            .where((element) => element.typeId.toString() == "2")
            .toList();
        isLoading = false;
        setState(() {});
      }
